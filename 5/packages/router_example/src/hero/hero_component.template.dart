...
import 'package:router_example/src/hero/hero_component.css.shim.dart' as import0;
...
class _ViewHeroComponentHost0 extends AppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    _HeroComponent_0_5 = new import2.HeroComponent(this.injectorGet(import18.HeroService, viewData.parentIndex), this.injectorGet(import19.Router, viewData.parentIndex));
