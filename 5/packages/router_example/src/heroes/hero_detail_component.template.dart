...
class _ViewHeroDetailComponentHost0 extends AppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    _HeroDetailComponent_0_4 = new import2.HeroDetailComponent(this.injectorGet(import17.HeroService, viewData.parentIndex), this.injectorGet(import18.Router, viewData.parentIndex), this.injectorGet(dynamic, viewData.parentIndex));
