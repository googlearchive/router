...
import 'package:router_example/src/heroes/hero_detail_component.css.shim.dart' as import0;
...
class _ViewHeroDetailComponentHost0 extends AppView<dynamic> {
  ...
  ComponentRef build() {
    ...
    _HeroDetailComponent_0_5 = new import2.HeroDetailComponent(this.injectorGet(import18.HeroService, viewData.parentIndex), this.injectorGet(import19.Router, viewData.parentIndex), this.injectorGet(dynamic, viewData.parentIndex));
