define(['dart_sdk', 'packages/angular_router/angular_router.template'], function(dart_sdk, angular_router) {
  ...
  dart.trackLibraries("packages/router_example/src/route_paths.template.ddc", {
    "package:router_example/src/route_paths.template.dart": src__route_paths$46template
