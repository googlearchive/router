...
class ViewCrisisDetailComponent0 extends AppView<import2.CrisisDetailComponent> {
  ...
  ComponentRef<import2.CrisisDetailComponent> build() {
    ...
    TemplateRef _TemplateRef_0_8 = new TemplateRef(_appEl_0, viewFactory_CrisisDetailComponent1);
...
class _ViewCrisisDetailComponentHost0 extends AppView<dynamic> {
  ...
  import2.CrisisDetailComponent _CrisisDetailComponent_0_5;
  ...
  ComponentRef build() {
    ...
    _CrisisDetailComponent_0_5 = new import2.CrisisDetailComponent(this.injectorGet(import18.CrisisService, viewData.parentIndex), this.injectorGet(import19.Router, viewData.parentIndex), this.injectorGet(dynamic, viewData.parentIndex), this.injectorGet(import20.DialogService, viewData.parentIndex));
    _compView_0.create(_CrisisDetailComponent_0_5, projectableNodes);
    init0(rootEl);
    return new ComponentRef<import2.CrisisDetailComponent>(0, this, rootEl, _CrisisDetailComponent_0_5);
  }
  ...
  void detectChangesInternal() {
    bool firstCheck = (this.cdState == 0);
    if (firstCheck) {
      _CrisisDetailComponent_0_5.ngOnInit();
    }
