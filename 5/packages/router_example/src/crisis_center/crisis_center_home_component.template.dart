...
class _ViewCrisisCenterHomeComponentHost0 extends AppView<dynamic> {
  ...
  import1.CrisisCenterHomeComponent _CrisisCenterHomeComponent_0_5;
  ...
  ComponentRef build() {
    ...
    _CrisisCenterHomeComponent_0_5 = new import1.CrisisCenterHomeComponent();
    _compView_0.create(_CrisisCenterHomeComponent_0_5, projectableNodes);
    init0(rootEl);
    return new ComponentRef<import1.CrisisCenterHomeComponent>(0, this, rootEl, _CrisisCenterHomeComponent_0_5);
  }
