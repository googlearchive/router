define(['dart_sdk', 'packages/angular/angular.template', 'packages/angular_router/angular_router.template', 'packages/router_example/app_component.template', 'packages/angular/src/platform/bootstrap', 'packages/router_example/app_component', 'packages/angular_router/src/constants'], function(dart_sdk, angular, angular_router, app_component, bootstrap, app_component$, constants) {
  'use strict';
